...
\begin{itemize}
    ...
    \item Integrate XAI techniques into the model (LIME and SHAP), compare the performance of these techniques. Measure, if any, the latency introduced by integrating XAI and discuss the trade off between explainability and performance of real-time attack detection.
\end{itemize}
...
To compare the interpretability and latency trade-off, both SHAP and LIME will be tested on the model. LIME and SHAP will be used to show which features were the most important when making a prediction. There will then be a comparison between the latency introduced by each method, as well as the consistency of the explanations they provide.
