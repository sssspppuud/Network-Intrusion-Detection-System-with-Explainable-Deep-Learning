...
\subsection{IoMT Architecture and Security Issues}
...
\\
The variety of areas that are vulnerable in these systems highlights the need for a more rigorous and trustworthy cybersecurity system to prevent a rise in successful attacks. One highly researched solution to this is Intrusion Detection Systems (IDS).

\subsection{Detection Methods for IoMT Attacks}
