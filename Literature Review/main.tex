...
To maximise the realism of the data used to train the proposed model, this project will use the CIC2024 IoMT Dataset. This dataset was specifically synthesised for benchmarking security systems for IoMT. It involves traffic types missing from the previously mentioned datasets including common protocols used by IoMT such as MQTT and Bluetooth. The dataset also provides a wide variety of attack vectors and devices connected to the network. \cite{dadkhah2024ciciomt2024}.
