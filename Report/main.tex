...
There is limited work in applying XAI techniques specifically to IoMT scenarios, the trade-off experienced between interpretability and latency remains under-researched. Aiming to address this gap will allow the development of more trustworthy IDS models in healthcare settings that use IoMT networks.
