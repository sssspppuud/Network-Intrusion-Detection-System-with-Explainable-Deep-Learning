...
To compare the interpretability and latency trade-off, both SHAP and LIME will be tested on the model. Both will be used to show which features were the most important when making a prediction. There will then be a comparison between the latency introduced by each method, as well as the consistency of the explanations they provide.
